    ...
    <div className="min-h-screen pt-20">
      <div className="container-center mb-10">
        <div className="text-center mb-12">
          <h1 className="text-2xl font-medium tracking-widest">{venue.name}</h1>
          <p className="text-white/60 font-light">Booking Experience</p>
        </div>
        ...
        <div className="flex justify-between items-center mb-8 px-6">
          {[0, 1, 2, 3, 4].map((step) => (
            <div key={step} className="flex flex-col items-center">
              ...
              />
              <div className={`h-[1px] w-12 ${step === 4 ? 'hidden' : 'block'} ${
